export type { DnsProviderAdapter, DnsZone, DnsRecord, DnsRecordInput, PowerDnsConfig, RndcConfig, CloudflareConfig, Route53Config, HetznerDnsConfig, ClouDnsConfig, MockConfig } from './types.js';
...
export { ClouDnsProvider } from './cloudns.js';

import type { DnsProviderAdapter, MockConfig, PowerDnsConfig, RndcConfig, CloudflareConfig, Route53Config, HetznerDnsConfig, ClouDnsConfig } from './types.js';
...
export function createProvider(providerType: string, config: Record<string, unknown>): DnsProviderAdapter {
  switch (providerType) {
    ...
    case 'cloudns':
      return new ClouDnsProvider(config as unknown as ClouDnsConfig);
    default:
