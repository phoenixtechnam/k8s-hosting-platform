    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <HardDrive size={28} className="text-gray-700" />
          <h1 className="text-2xl font-bold text-gray-900" data-testid="backup-settings-heading">Backup Configuration</h1>
        </div>
        <button
          type="button"
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm space-y-4" data-testid="backup-config-form">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="bc-name" className="block text-sm font-medium text-gray-700">Name</label>
            ...
            <div>
              ...
              <div className="mt-1 flex gap-2">
                <button type="button" onClick={() => setStorageType('ssh')} className={`flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium border ${storageType === 'ssh' ? 'border-brand-500 bg-brand-50 text-brand-700' : 'border-gray-200 text-gray-600'}`} data-testid="bc-type-ssh">
                  <Server size={14} /> SSH
                </button>
                <button type="button" onClick={() => setStorageType('s3')} className={`flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium border ${storageType === 's3' ? 'border-brand-500 bg-brand-50 text-brand-700' : 'border-gray-200 text-gray-600'}`} data-testid="bc-type-s3">
                  <Cloud size={14} /> S3
                </button>
              </div>
            </div>
          ...
          {storageType === 'ssh' && (
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="bc-ssh-host" className="block text-sm font-medium text-gray-700">SSH Host</label>
              ...
              <div>
                <label htmlFor="bc-ssh-port" className="block text-sm font-medium text-gray-700">SSH Port</label>
              ...
              <div>
                <label htmlFor="bc-ssh-user" className="block text-sm font-medium text-gray-700">SSH User</label>
              ...
              <div>
                <label htmlFor="bc-ssh-path" className="block text-sm font-medium text-gray-700">Remote Path</label>
              ...
              <div className="sm:col-span-2">
                <label htmlFor="bc-ssh-key" className="block text-sm font-medium text-gray-700">SSH Private Key</label>
          ...
          {storageType === 's3' && (
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="bc-s3-endpoint" className="block text-sm font-medium text-gray-700">S3 Endpoint</label>
              ...
              <div>
                <label htmlFor="bc-s3-bucket" className="block text-sm font-medium text-gray-700">Bucket</label>
              ...
              <div>
                <label htmlFor="bc-s3-region" className="block text-sm font-medium text-gray-700">Region</label>
              ...
              <div>
                <label htmlFor="bc-s3-prefix" className="block text-sm font-medium text-gray-700">Prefix <span className="text-xs text-gray-400">(optional)</span></label>
              ...
              <div>
                <label htmlFor="bc-s3-access" className="block text-sm font-medium text-gray-700">Access Key</label>
              ...
              <div>
                <label htmlFor="bc-s3-secret" className="block text-sm font-medium text-gray-700">Secret Key</label>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="bc-retention" className="block text-sm font-medium text-gray-700">Retention (days)</label>
            ...
            <div>
              <label htmlFor="bc-schedule" className="block text-sm font-medium text-gray-700">Schedule (cron)</label>
          ...
          {createConfig.error && (
            <div className="flex items-center gap-2 text-sm text-red-600"><AlertCircle size={14} />{createConfig.error instanceof Error ? createConfig.error.message : 'Failed to create'}</div>
          )}
      ...
      {!isLoading && configs.length === 0 && !showForm && (
        <div className="rounded-xl border border-gray-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="text-sm text-gray-500">No backup targets configured. Add one to get started.</p>
        </div>
      )}
      ...
      {!isLoading && configs.length > 0 && (
        <div className="space-y-3">
          {configs.map((config) => (
            <div key={config.id} className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm" data-testid={`backup-config-${config.id}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  {config.storageType === 'ssh' ? <Server size={18} className="text-gray-500" /> : <Cloud size={18} className="text-blue-500" />}
                  <div>
              ...
              <div className="mt-3 flex gap-2">
                <button type="button" onClick={() => handleTest(config.id)} disabled={testConfig.isPending} className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50" data-testid={`test-backup-${config.id}`}>
                ...
                {deleteConfirmId === config.id ? (
                  <div className="flex gap-1">
                    ...
                    <button type="button" onClick={() => setDeleteConfirmId(null)} className="rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-50">Cancel</button>
                  </div>
                ) : (
                  <button type="button" onClick={() => setDeleteConfirmId(config.id)} className="inline-flex items-center gap-1.5 rounded-lg border border-red-200 px-3 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50" data-testid={`delete-backup-${config.id}`}>
